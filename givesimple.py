...
if __name__ == "__main__":
    ...
    donation_ratio = analytics.donation_to_income_ratio(donation_amount,
                                                        yearly_income)
    credit_ratio = analytics.credit_to_donation_ratio(total_credit,
                                                      donation_amount)
    ...
    analytics.plot_analytics(yearly_income, province)
