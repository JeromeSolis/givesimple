var giving_what_we_can_pledge = 0.1;
var donation_limit = 200;
var high_income_tax_credit_rate = 0.33;
var high_income_limit = 200000;
...
function getTaxCredit(donationAmount, yearlyIncome, highIncome, region) {
    var federalData = canada_charity_tax_credit_data.find(function (data) { return data.region === 'CA'; });
    var provincialData = canada_charity_tax_credit_data.find(function (data) { return data.region === region; });
    var federalCredit = 0;
    var provincialCredit = 0;
...
var value = getTaxCredit(20000, 215000, true, 'QC');
